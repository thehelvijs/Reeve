...
func (a *app) routes() http.Handler {
	...
	mux.HandleFunc("GET /api/v1/collections/{id}/icon", a.serveImage(collectionIcon))
	...
	mux.HandleFunc("GET /api/v1/tools/{id}/icon", a.serveImage(toolIcon))
	mux.Handle("POST /api/v1/tools/{id}/icon", authed(a.uploadImage(toolIcon)))
	mux.Handle("DELETE /api/v1/tools/{id}/icon", authed(a.deleteImage(toolIcon)))
	mux.HandleFunc("GET /api/v1/tools/{id}/thumbnail", a.serveImage(toolThumbnail))
	mux.Handle("POST /api/v1/tools/{id}/thumbnail", authed(a.uploadImage(toolThumbnail)))
	mux.Handle("DELETE /api/v1/tools/{id}/thumbnail", authed(a.deleteImage(toolThumbnail)))
	...
	mux.Handle("POST /api/v1/collections/{id}/icon", authed(a.uploadImage(collectionIcon)))
	mux.Handle("DELETE /api/v1/collections/{id}/icon", authed(a.deleteImage(collectionIcon)))
	...
	mux.HandleFunc("GET /api/v1/hosts/{id}/icon", a.serveImage(hostIcon))
	mux.HandleFunc("GET /api/v1/hosts/{id}/thumbnail", a.serveImage(hostThumbnail))
	...
	mux.Handle("POST /api/v1/admin/hosts/{id}/icon", admin(a.uploadImage(hostIcon)))
	mux.Handle("DELETE /api/v1/admin/hosts/{id}/icon", admin(a.deleteImage(hostIcon)))
	mux.Handle("POST /api/v1/admin/hosts/{id}/thumbnail", admin(a.uploadImage(hostThumbnail)))
	mux.Handle("DELETE /api/v1/admin/hosts/{id}/thumbnail", admin(a.deleteImage(hostThumbnail)))
