...
func (a *app) routes() http.Handler {
	...
	mux.Handle("GET /api/admin/webhook-formats", admin(http.HandlerFunc(a.handleChannelFormats)))
	mux.Handle("POST /api/admin/webhooks", admin(http.HandlerFunc(a.handleCreateWebhook)))
	mux.Handle("PATCH /api/admin/webhooks/{id}", admin(http.HandlerFunc(a.handleUpdateWebhook)))
