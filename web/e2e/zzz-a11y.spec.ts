...
test.describe('authed app', () => {
  ...
  for (const [name, path] of Object.entries({
    ...
    // Excluded from the visual sweep as a live machine readout, so this is the
...
// A modal is the easiest thing to get wrong: it has to be announced as a dialog
// and its controls have to be reachable and named.
