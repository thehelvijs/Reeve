...
export default function VisibilityToggle({
  ...
  return (
    <button
      ...
      className={`inline-flex shrink-0 items-center rounded-pill border px-2 py-0.5 text-xs font-medium transition-[filter] hover:brightness-95 dark:hover:brightness-125 disabled:opacity-50 ${styles}`}
    >
